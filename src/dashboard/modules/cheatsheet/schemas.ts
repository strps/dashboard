...
export const cheatsheetConfigSchema = z.object({
  filterButtons: filterButtonsSchema,
});
export type CheatsheetConfig = z.infer<typeof cheatsheetConfigSchema>;

export const defaultCheatsheetConfig: CheatsheetConfig = {
  filterButtons: [],
};
